...
const NotificationPanel: React.FC<NotificationPanelProps> = ({ 
  ...
  return (
    <>
      ...
      {/* Panel - Changed from right-0 to left-0 and translate-x-full to -translate-x-full */}
      <aside 
        className={`fixed top-0 left-0 h-full w-80 md:w-96 bg-white shadow-2xl z-50 transform transition-transform duration-300 ease-out border-r border-slate-100 ${isOpen ? 'translate-x-0' : '-translate-x-full'}`}
      >
